        ...
        <div v-if="products" v-for="product in products" :key="product.product_id">
          <div class="relative bg-white rounded-lg overflow-hidden p-3 m-3 w-80 border border-gray-300"
            ...
            <div class="p-6">
              ...
              <div class="flex">
                <svg v-for="n in (Math.floor(product.avg_rating) ? Math.floor(product.avg_rating) : 0)" :key="n" xmlns="http://www.w3.org/2000/svg" fill="yellow"
                ...
                <svg v-for="n in 5 - (Math.floor(product.avg_rating) ? Math.floor(product.avg_rating) : 0)" :key="n" xmlns="http://www.w3.org/2000/svg"
